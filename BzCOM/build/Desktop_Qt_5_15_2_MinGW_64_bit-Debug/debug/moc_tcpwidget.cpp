...
QT_MOC_LITERAL(4, 29, 13), // "systemMessage"
QT_MOC_LITERAL(5, 43, 3), // "msg"
QT_MOC_LITERAL(6, 47, 22), // "connectionStateChanged"
QT_MOC_LITERAL(7, 70, 9) // "connected"

    },
    "tcpWidget\0dataReceived\0\0data\0systemMessage\0"
    "msg\0connectionStateChanged\0connected"
};
...
void tcpWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->systemMessage((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (tcpWidget::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&tcpWidget::dataReceived)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (tcpWidget::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&tcpWidget::systemMessage)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (tcpWidget::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&tcpWidget::connectionStateChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void tcpWidget::dataReceived(const QByteArray & _t1)
{
...
// SIGNAL 1
void tcpWidget::systemMessage(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void tcpWidget::connectionStateChanged(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
