...
QT_MOC_LITERAL(4, 30, 8), // "dataSent"
QT_MOC_LITERAL(5, 39, 9), // "hexString"
QT_MOC_LITERAL(6, 49, 13), // "systemMessage"
QT_MOC_LITERAL(7, 63, 3) // "msg"

    },
    "uartWidget\0dataReceived\0\0data\0dataSent\0"
    "hexString\0systemMessage\0msg"
};
...
void uartWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<uartWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 2: _t->systemMessage((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (uartWidget::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&uartWidget::dataReceived)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (uartWidget::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&uartWidget::dataSent)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (uartWidget::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&uartWidget::systemMessage)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject uartWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_uartWidget.data,
    qt_meta_data_uartWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void uartWidget::dataReceived(const QByteArray & _t1)
{
...
// SIGNAL 1
void uartWidget::dataSent(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void uartWidget::systemMessage(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
